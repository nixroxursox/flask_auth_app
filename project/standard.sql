...
CREATE DATABASE IF NOT EXISTS `BCMART` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `BCMART`;
...
CREATE USER 'bcuser'@'localhost'
  IDENTIFIED BY 'passw0rd';
  GRANT ALL ON *.* TO 'bcuser'@'localhost'
  WITH GRANT OPTION;
